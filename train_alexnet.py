...
class TrainModel:
    def __init__(self):
        ...
        self.optimizer = optim.Adam(self.model.classifier[6].parameters(), lr=self.learning_rate)
        ...
        filename = 'checkpoint-alexnet.pth.tar'
    ...
    def train(self):
        def save_checkpoint(state, better, file=os.path.join(args.save, 'checkpoint-alexnet.pth.tar')):
