...
class TrainModel:
    def __init__(self):
        ...
        filename = 'checkpoint-resnet34.pth.tar'
    ...
    def train(self):
        def save_checkpoint(state, better, file=os.path.join(args.save, 'checkpoint-resnet34.pth.tar')):
            torch.save(state, file)
            if better:
                shutil.copyfile(file, os.path.join(args.save, 'resnet34_model.pth.tar'))
